...
class ServiceLocator
{
	 ...
	 * @var IVoiceService
	 */
	private static $_voiceService = null;	
	 ...
	 * @return VoiceService
	 */
	public static function GetVoiceService()
    {
        require_once(ROOT_DIR . 'lib/Voice/namespace.php');

        if (self::$_voiceService == null)
        {
            self::$_voiceService = new VoiceService();
        }
        return self::$_voiceService;
    }	
