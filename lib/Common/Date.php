...
class Date
{
	...
	public static function ParseExact($dateString)
	{
		...
		if (StringHelper::Contains($offset, '+'))
		{
			$hourAdjustment *= -1;
			$minuteAdjustment *= -1;
		}
