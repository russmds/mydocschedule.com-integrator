...
<h1>MyDocSchedule.com Help</h1>

<div id="help">
<h2>Registration</h2>

<p>
	Registration is required in order to use MyDocSchdedule.com if you administrator has enabled it. After your account
	has been registered
...
<p>Open Google Calendar settings. Click the Calendars tab. Click Browse interesting calendars. Click add by URL. Paste
	in the URL printed under the Subscribe to this Calendar link in ScheduleAndBook.com.</p>
